...
export default function AdsListScreen() {
  ...
  // Hub's "+" on the Объявления block links here with ?new=1 to jump
  // straight into the create form instead of the list.
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <Stack.Screen options={{ title: 'Объявления', headerBackTitle: t('common.back') }} />
